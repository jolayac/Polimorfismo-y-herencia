# Tomado de AccessModifiersPython
...
class FirebaseRealtimeService:
    """
    Servicio de acceso a Firebase Realtime Database para animales.
    ...
    def __init__(self, base_path: str = "animals"):
        self._ensure_sdk()
    ...
    def _ensure_sdk(self):
        ...
        if not firebase_admin._apps:  # type: ignore[attr-defined]
            ...
            if not creds_json:
                raise RuntimeError(
                    "Falta variable de entorno FIREBASE_CREDENTIALS_JSON")
            ...
            if os.path.isfile(creds_json):
                ...
                try:
                    ...
                    raise RuntimeError(
                        "FIREBASE_CREDENTIALS_JSON inválido: no es ruta ni JSON válido") from exc
    ...
    def list_all(self) -> Dict[str, Dict[str, Any]]:
        ...
        if not isinstance(val, dict):
            raise ValueError(
                "Formato inesperado en RTDB: se esperaba dict de items")
